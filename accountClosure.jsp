...
<%
	...
	String query = "select passwd from USERS where userId='" + session.getAttribute("logged_in_as") + "';";
	ResultSet r = st.executeQuery(query);
	r.next();
	try{
		String passwd = request.getParameter("passwd");
		if(passwd != null){
			if(passwd.equals(r.getString("passwd"))){
				query = "update USERS set deactive='t' where userId='" + session.getAttribute("logged_in_as") + "';";
...
<body style="background: rgb(241,247,252);">
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background: rgb(163,178,217);">
        <div class="container"><a class="navbar-brand" href="/">SlothBank</a><span>Account Closure</span><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <% } %>
    <h1 style="text-align: center;font-family: 'Alegreya SC', serif;margin-top: 100px;"><strong>account closure :</strong></h1>
    <form style="margin-top: 50px;text-align: left;margin-right: 300px;margin-left: 300px;" action="accountClosure.jsp" method="post"><label class="form-label">Please enter your password to close your account :<br></label><input class="form-control" name="passwd" type="password" style="width: 250px;"><input class="form-control" type="submit" style="width: 250px;"></form>
