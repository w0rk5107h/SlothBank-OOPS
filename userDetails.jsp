...
<body style="background: rgb(241,247,252);">
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background: rgb(163,178,217);">
        <div class="container"><a class="navbar-brand" href="/">SlothBank</a><span>User Details</span><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <% } %>
    <h1 style="text-align: center;font-family: 'Alegreya SC', serif;margin-top: 100px;"><strong>User Details:</strong></h1>
    <div class="table-responsive" style="margin-right: 300px;margin-left: 300px;margin-top: 50px;">
        <table class="table">
            <thead>
                <tr></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= r.getString("adl1") %></td>
                </tr>
                <tr>
                    <td>Address Line 2</td>
                    <td><%= r.getString("adl2") %></td>
                </tr>
                <tr>
                    <td>City</td>
